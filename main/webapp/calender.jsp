  ...
  <div class="right-area">
    <div class="right-area-upper">
      ...
      <div class="search-part-wrapper">
        ...
        <a class="menu-links" href="scroll.jsp">Logout</a>
...
<div id="calendar-popup">
  ...
  <form class="form-control" method="post" action="./eventsAction.jsp">
...
제목</label>
        <input id="event-title"  class='form-control' type="text" name="eventname"/>
      </li>
      <li>
...
메모</label>
        <input id="event-details" type="text" class='form-control' name="details">
      </li>
      <div class="button">
        <input id="memo" type="submit"  class='form-control submit_btn'/>
      </div>
    </ul>
  </form>
 ...
 End</p>
      ...
      <li>
        <p>
          <i class="fa fa-map-marker" aria-hidden="true" id="memo"></i>Location</p>
<p class="location"></p>
      </li>
      <li>
...
Details:</p>
  ...
  <div class="prong">
    <div id="memo" class="bottom-prong-dk"></div>
    <div id="memo"class="bottom-prong-lt"></div>
  </div>
</div>
...
<div class='modle' id='simplemodal'>
  <div class='modle-continer'>
      <form id="edit-form" class="form" method="post" action="./eventsAction.jsp">
