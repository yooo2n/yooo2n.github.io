    ...
    <div class="left-area-content">
      <div class="profile">
        ...
        <a href="page1.jsp" class="item-link" id="pageLink">
          ...
          Favourites</a>
        <a href="boardList.jsp" class="item-link" id="pageLink">
  ...
  <div class="right-area">
      ...
      <div class="content-line content-line-hero">
        ...
        <div class="slider-wrapper owl-carousel owl-theme" id="owl-slider-1">
          <div class="item hero-img-wrapper img-1">
            ...
            <img src="./img/sea.jpg" alt="SlideShow">
          </div>
          <div class="item hero-img-wrapper img-2">
            ...
            <img src="./img/park.jpg" alt="SlideShow">
          </div>
          <div class="item hero-img-wrapper img-3">
            ...
            <img src="./img/sea1.jpg" alt="SlideShow">
          </div>
        </div>
      </div>
    ...
    <main role="main" class="container">
      ...
      <center>
       ...
       <div class="leaf" id="leaf" href="#"><img src="./img/leaf.png"></div>
       
       <div class="apptree" id="apptree" href="#"><img src="./img/appletree.png"></div>
        ...
        <form>
          <div class="popup" id="modal">
            <div class="title">방명록 작성</div>
               <div class="content">
                 <table class="tbl">
                      <tr>
                        <td>
                        <input type="text" name="uContent" placeholder="내용을 입력해주세요">
                        </td>
                       </tr>
                 </table>
            </div>
            <div class="cmd">
              ...
              <tr>
            <td colspan="2"><input type="submit" id="submit" class="button" value="등록"></td>
           </tr>
           </div>
         </div>
       </form>
       ...
       <!-- 작성된 방명록 창  -->
         <form>
          <div class="popupMessage" id="messageModal">
            ...
            String message=request.getParameter("uContent");
            if(message!=null) {
...
<script>
    ...
    document.getElementById("appetree").onclick = function() {
